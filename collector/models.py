...
class TwitterData(models.Model):
    ...
    latitude = models.DecimalField(null=True,max_digits=11, decimal_places=7, blank=True)
    longitude = models.DecimalField(null=True,max_digits=11, decimal_places=7, blank=True)
